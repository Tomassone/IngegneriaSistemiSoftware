...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     sys >> Edge( label='syncevent', **evattr, decorate='true', fontcolor='darkgreen') >> firefly
     orchestrator >> Edge( label='syncevent', **eventedgeattr, decorate='true', fontcolor='red') >> sys
