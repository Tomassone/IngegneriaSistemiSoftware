		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
						...
						CommUtils.outmagenta("$name | X=$X Y=$Y Freq=$Freq")
				...
				state("flash") { //this:State
					...
					sysaction { //it:State
				 	 		stateTimer = TimerActor("timer_flash", 
				 	 					  scope, context!!, "local_tout_"+name+"_flash", Freq )  //OCT2023
					}	 	 
					 transition(edgeName="t00",targetState="flash",cond=whenTimeout("local_tout_"+name+"_flash"))   
					transition(edgeName="t01",targetState="sync",cond=whenEvent("syncevent"))
				}	 
